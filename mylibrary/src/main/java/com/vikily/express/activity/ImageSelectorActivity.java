...
import com.vikily.express.R;
import com.vikily.express.adapter.SelectorAdapter;
import com.vikily.express.model.ISelectImageItem;
import com.vikily.express.model.Img;
import com.vikily.express.view.GridSpacingItemDecoration;
...
public class ImageSelectorActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    public Loader<Cursor> onCreateLoader(int id, Bundle args) {
        ...
        return new CursorLoader(this, uri, IMAGE_PROJECTION, select, null, MediaStore.Images.Media.DATE_MODIFIED + " DESC");
    }
